  ...
  <div class="profile-container q-pa-md">
    <q-card class="profile-card" v-if="editableUser">
      <div class="status-banners">
        ...
        <q-banner
          v-if="!editableUser.totaraDone && isCurrentUser"
          class="text-white bg-red-6"
          rounded
        >
          <template v-slot:avatar>
          ...
          <b
            >Please complete the Totara training before you can attend exams.</b
          >
        </q-banner>
        <q-banner
          v-else-if="
        ...
        <q-banner
          v-if="!editableUser.activatedAccount"
        ...
        >
          ...
          <div v-if="isCurrentUser && !editableUser.activatedAccount">
            ...
            <ul class="q-mt-sm q-mb-none">
              ...
              <li v-if="!editableUser.passwordUpdated">
                (Optional but recommended) Update your password
              </li>
              <li v-if="!editableUser.avatarUrl">
                (Optional) Update your avatar
              </li>
            </ul>
          </div>
          <div
            v-else-if="
              !editableUser.activatedAccount &&
              currentUser.role.includes(RoleEnum.Office)
            "
          >
      ...
      <div class="profile-header q-pa-lg text-center">
        <div class="avatar-container">
          <q-avatar size="180px" class="shadow-5">
            ...
            <div
              v-else
              class="text-h4 text-weight-bold bg-primary text-white flex flex-center"
            >
              {{ getInitials(editableUser) }}
            </div>
          </q-avatar>
                  ...
                  <div class="row q-col-gutter-md">
                    ...
                    >
                      <q-input
                        ...
                        :label="field.label"
                        :type="
                          field.key === 'dateOfBirth' ? 'text' : field.type
                        "
                        :mask="
                          field.key === 'dateOfBirth' ? '####-##-##' : undefined
                        "
                        outlined
                        dense
                        stack-label
                      ...
                      <div class="field-display">
                        ...
                        <div class="text-body1">
                          {{
                            formatFieldValue(
                              editableUser[
                                field.key as keyof typeof editableFields
                              ],
                              field.type
                            )
                          }}
            ...
            <q-card flat bordered class="content-card">
              <q-card-section>
                ...
                <div class="q-mt-sm">
                  <template
                    v-if="
                      editableUser?.adminCentre &&
                      editableUser.adminCentre.length > 0
                    "
                  >
                    <q-chip
              ...
              <q-card-section>
                ...
                <template v-else>
                  <div class="row q-col-gutter-md">
                    <div
                      class="col-12"
                      v-for="field in availabilityFieldsStranger"
                      :key="field.label"
                    >
                      <div class="field-display">
                        <div class="text-subtitle2 text-grey-7">
                ...
                <div class="row q-col-gutter-lg">
                      ...
                      <q-item>
                        <q-item-section>
                          <q-input
                            ...
                            mask="####-##-##"
                            :disable="
                              !editableUser.totaraDone || !isCurrentUser
                            "
                            outlined
                            dense
                          >
                  ...
                  <div class="col-12 col-md-6" v-if="showExamCounts">
                    <q-list bordered>
                      <q-item
                        v-if="
                          editableUser._count?.supervisedExams !== undefined
                        "
                      >
                        ...
                        <q-item-section>
                          ...
                          <q-item-label caption>{{
                            editableUser._count.supervisedExams
                          }}</q-item-label>
                        </q-item-section>
                      </q-item>
                      ...
                      >
                        ...
                        <q-item-section>
                          ...
                          <q-item-label caption>{{
                            editableUser._count.invigilatedExams
                          }}</q-item-label>
                        </q-item-section>
                      </q-item>
                      ...
                      >
                        ...
                        <q-item-section>
                          ...
                          <q-item-label caption>{{
                            editableUser._count.examinedExams
                          }}</q-item-label>
                        </q-item-section>
                      </q-item>
                    </q-list>
...
const availabilityFields: EditableUserField[] = [
  ...
  },
  {
    ...
    type: 'textarea',
    hint: 'Please give us more detailed information about your availability',
  },
];
...
const hasChanges = computed(
  () => !deepEqual(editableUser.value, initialUser.value, datesToCheck)
);
...
const updateProfile = async () => {
  ...
  const normalizedTotaraDate = normalizeDateString(
    editableUser.value.totaraDate
  );
  const normalizedEditableTotaraDate = normalizeDateString(
    editableFields.totaraDate
  );

  const normalizedDateOfBirth = normalizeDateString(
    editableUser.value.dateOfBirth
  );
  const normalizedEditableDateOfBirth = normalizeDateString(
